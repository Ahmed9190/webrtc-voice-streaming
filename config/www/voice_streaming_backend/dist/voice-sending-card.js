import{i as t,_ as e,n as i,r as a,a as s,b as n,t as o,e as r,s as c,W as l}from"./styles-YY3p615I.js";let h=class extends s{setConfig(t){this._config=t}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;const a=void 0!==e.checked?e.checked:e.value;if(this._config[i]===a)return;const s={...this._config};""===a&&void 0===e.checked?delete s[i]:s[i]=a,this._config=s,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){return this.hass&&this._config?n`
  ...
  `,e([i({attribute:!1})],h.prototype,"hass",void 0),e([a()],h.prototype,"_config",void 0),h=e([o("voice-sending-card-editor")],h);let d=class extends s{constructor(){super(...arguments),this.status="disconnected",this.errorMessage="",this.latency=0,this.webrtc=null,this.animationFrame=null}static get styles(){return[c,t`
    ...
    `}};e([i({attribute:!1})],d.prototype,"hass",void 0),e([a()],d.prototype,"config",void 0),e([a()],d.prototype,"status",void 0),e([a()],d.prototype,"errorMessage",void 0),e([a()],d.prototype,"latency",void 0),e([r("canvas")],d.prototype,"canvas",void 0),d=e([o("voice-sending-card")],d),window.customCards=window.customCards||[],window.customCards.push({type:"voice-sending-card",name:"Voice Sending Card",description:"Send voice audio via WebRTC",preview:!0,editor:"voice-sending-card-editor"});export{d as VoiceSendingCard};
