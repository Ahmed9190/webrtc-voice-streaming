import{i as t,_ as e,n as i,r as s,t as a,a as r,b as n,e as o,s as c,W as l}from"./styles-CCznnD0D.js";let d=class extends r{setConfig(t){this._config=t}_valueChanged(t){if(!this._config||!this.hass)return;const e=t.target,i=e.configValue;if(!i)return;const s=void 0!==e.checked?e.checked:e.value;if(this._config[i]===s)return;const a={...this._config};""===s&&void 0===e.checked?delete a[i]:a[i]=s,this._config=a,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){return this.hass&&this._config?n`
