import{i as e,_ as t,n as i,r as a,a as s,b as n,t as o,e as r,s as c,W as l}from"./styles-CCznnD0D.js";let h=class extends s{setConfig(e){this._config=e}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target,i=t.configValue;if(!i)return;const a=void 0!==t.checked?t.checked:t.value;if(this._config[i]===a)return;const s={...this._config};""===a&&void 0===t.checked?delete s[i]:s[i]=a,this._config=s,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){return this.hass&&this._config?n`
