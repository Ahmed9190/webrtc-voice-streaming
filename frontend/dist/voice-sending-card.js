import{i as e,_ as t,n as i,r as a,a as s,b as n,t as o,e as r,s as c,W as l}from"./styles-Dsp5ghNu.js";let h=class extends s{setConfig(e){this._config=e}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target,i=t.configValue;if(!i)return;const a=void 0!==t.checked?t.checked:t.value;if(this._config[i]===a)return;const s={...this._config};""===a&&void 0===t.checked?delete s[i]:s[i]=a,this._config=s,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){return this.hass&&this._config?n`
  ...
  `,t([i({attribute:!1})],h.prototype,"hass",void 0),t([a()],h.prototype,"_config",void 0),h=t([o("voice-sending-card-editor")],h);let d=class extends s{constructor(){super(...arguments),this.status="disconnected",this.errorMessage="",this.latency=0,this.webrtc=null,this.animationFrame=null}static get styles(){return[c,e`
    ...
    `}};t([i({attribute:!1})],d.prototype,"hass",void 0),t([a()],d.prototype,"config",void 0),t([a()],d.prototype,"status",void 0),t([a()],d.prototype,"errorMessage",void 0),t([a()],d.prototype,"latency",void 0),t([r("canvas")],d.prototype,"canvas",void 0),d=t([o("voice-sending-card")],d),window.customCards=window.customCards||[],window.customCards.push({type:"voice-sending-card",name:"Voice Sending Card",description:"Send voice audio via WebRTC",preview:!0,editor:"voice-sending-card-editor",version:"1.2.0"});export{d as VoiceSendingCard};
